module ApplicationHelper
  # Изображение для страниц регистрации,
  # и страницы входа на сайт
  def logo_template(images)
    asset_path(images)
  end

  def current_user_can_edit_photo?(photo)
    current_user.id == photo.user_id if user_signed_in?
  end
